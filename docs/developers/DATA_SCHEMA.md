...
## Data Schema (Tipos de Dados Validveis)

O protocolo valida três núcleos fundamentais (A Trindade):

### 1. Dados Fsicos (Physical Truth)
...
### 2. Dados Jurdicos (Juridical Truth)
