...
- **Capabilities**:
    - **Skill Inheritance**: Accesses protocol-level skills (`juridical-audit`, `ethical-alignment`).
...
4. **Weighted Synthesis**: GP-Architect consolidates the verdicts into a ZK-compatible state.
5. **On-Chain Anchor**: CRE commits the final proof to the blockchain.
