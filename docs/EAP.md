...
O GreenProof é subdividido em 4 pilares fundamentais, garantindo a integridade da "Trindade da Prova" e a conformidade institucional.

---

## 1. 🏗️ Pilar Arquitetura & Orquestração (CRE Base)
*   **1.1 Definição de Workflow**: Implementação do `workflow.ts` para coordenação de oráculos.
...
*   **2.2 Proving System**: Implementação off-chain do sistema de provas ZK-SNARK.
*   **2.3 Compliance Membrane**: Interface secreta para ingestão de dados OPER (Privacidade Industrial).
