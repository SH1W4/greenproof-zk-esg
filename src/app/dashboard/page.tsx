    ...
    <main className="min-h-screen bg-[#0F172A] text-[#f0fdf4] selection:bg-[#00FF88]/30 overflow-x-hidden font-sans">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 py-12 lg:py-24 grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
        ...
        <div className="lg:col-span-5 space-y-8">
            ...
            >
              {step === "idle" && (
                <div className="flex flex-col items-center text-center space-y-6">
                  ...
                  <p className="text-green-100/40 text-sm max-w-[200px]">
                    Awaiting triple-oracle data streams.
                  </p>
                </div>
              )}
              ...
              {(step === "minting" ||
                ...
                <div className="flex flex-col items-center gap-8">
                  <motion.div
                    ...
                    className={`w-40 h-56 rounded-[2rem] ${
                      step === "success" ? "bg-green-500" : "bg-white/5"
                    } flex flex-col p-6 items-center justify-between border-2 ${
                      step === "success"
                        ? "border-green-400 shadow-[0_30px_60px_rgba(34,197,94,0.4)]"
                        : "border-white/10"
                    }`}
                  >
                    ...
                    <Database
                      className={`w-16 h-16 ${
                        step === "success" ? "text-green-950" : "text-white/10"
                      }`}
                    />
          ...
          <div className="glass-card rounded-[2rem] p-6 h-48 overflow-hidden relative group">
            ...
            <div
              className="space-y-2 font-mono text-[11px] text-green-200/40"
              translate="no"
            >
              {logs.map((log, i) => (
                <motion.div
                  ...
                  className={`flex gap-2 ${
                    i === logs.length - 1 ? "text-green-400 font-bold" : ""
                  }`}
                >
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-8 py-24 space-y-20 border-t border-white/5">
        <div className="space-y-4 max-w-2xl">
          ...
          <p className="text-green-100/40 leading-relaxed text-lg">
            A arquitetura do GreenProof baseia-se em três pilares de realidade
            objetiva, coordenados pelo Chainlink CRE e protegidos por ZK-SNARKs.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-xs text-green-100/30 leading-relaxed">
              Visualize a orquestração em múltiplas camadas entre sensores IoT,
              nós Jurídicos e motores de pontuação de impacto.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-xs text-green-100/30 leading-relaxed">
              Mapeamento de alta densidade da lógica de orquestração CRE
              Chainlink usada para verificar alegações institucionais de ESG.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <footer className="relative z-10 py-20 flex justify-center opacity-20 border-t border-white/5 bg-black/5">
        <div className="flex items-center gap-8">
          <span className="text-[9px] font-bold tracking-[0.8em] uppercase">
            Symmetry
          </span>
          <span className="text-[9px] font-bold tracking-[0.8em] uppercase">
            Logic
