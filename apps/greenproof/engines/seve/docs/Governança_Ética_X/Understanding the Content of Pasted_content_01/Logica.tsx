...
export default function Logica() {
  ...
  useEffect(() => {
    fetch("/PCE_IA_Lógica_Operacional_Monetária_v1.0.md")
      .then((res) => res.text())
      .then((text) => setContent(text))
      .catch((err) => console.error("Erro ao carregar a lógica:", err));
  }, []);
        ...
        <div className="container py-4">
          <nav className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <Link href="/logica" className="text-blue-600 font-semibold">
                Lógica Operacional
              </Link>
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm border border-slate-200 p-8 md:p-12">
          {content ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-slate-600 mt-4">Carregando lógica operacional...</p>
            </div>
          )}
        </div>
      </main>
